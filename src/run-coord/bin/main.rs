...
use stoffel_mpc_coordinator::off_chain::{
    CoordinatorRPCServerSharedBase, FakeCoordinatorConnection, OffChainCoordinatorServer,
};
...
async fn main() {
    ...
    let port = 31415;
    let server_state =
        CoordinatorRPCServerSharedBase::<Fr>::new(hash, n, t, public_keys, args.n_inputs);
